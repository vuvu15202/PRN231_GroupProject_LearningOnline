...
namespace PRN231_GroupProject_LearningOnline.Migrations
{
    ...
    [Migration("20240519154511_dbcontextver3")]
            ...
            modelBuilder.Entity("PRN231_GroupProject_LearningOnline.temp.CourseEnroll", b =>
                {
                    ...
                    b.Property<string>("StudentFeeId1")
                        .HasColumnType("nvarchar(255)");
                    ...
                    b.HasIndex("StudentFeeId1")
                        .IsUnique()
                        .HasFilter("[StudentFeeId1] IS NOT NULL");
            ...
            modelBuilder.Entity("PRN231_GroupProject_LearningOnline.temp.CourseEnroll", b =>
                {
                    ...
                    b.HasOne("PRN231_GroupProject_LearningOnline.Models.Entity.StudentFee", null)
                        .WithOne("CourseEnroll")
                        .HasForeignKey("PRN231_GroupProject_LearningOnline.temp.CourseEnroll", "StudentFeeId1");
