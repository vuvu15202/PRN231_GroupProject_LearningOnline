...
$(document).ready(function () {
    ...
    function ShowReport() {
        $.ajax({
            url: "https://localhost:5000/api/StudentFees/report",
            type: "get",
            headers: {
    ...
    function ShowProjectBills() {
        ...
        $.ajax({
            url: "https://localhost:5000/api/StudentFees/CoursesStudentFees",
            type: "get",
            headers: {
                "Authorization": "Bearer " + token,
            },
    ...
    function showHandlingbills(){
      $("#handlingbills").html("");
        $.ajax({
            url: "https://localhost:5000/api/StudentFees/handlingbills",
            type: "get",
            headers: {
                "Authorization": "Bearer " + token,
            },
    ...
    function showListOfBills(){
        ...
        $.ajax({
            url: "https://localhost:5000/api/StudentFees/GetStudentFeesByDate",
            type: "post",
            headers: {
                "Authorization": "Bearer " + token,
            },
    ...
    $(document).on('click', '.viewprojectbills', function(){
        ...
        $.ajax({
            url: "https://localhost:5000/api/StudentFees/CourseStudentFees/" + id,
            type: "get",
            headers: {
                "Authorization": "Bearer " + token,
            },
