...
$(document).ready(function () {
    ...
    function ShowReport() {
        $.ajax({
            url: "https://localhost:5000/api/BillingAPI/report",
            type: "get",
            headers: {
    ...
    function ShowProjectBills() {
        ...
        var token = getCookie("token"); console.log(token);
        $.ajax({
            url: "https://localhost:5000/api/BillingAPI/projectbills",
            type: "get",
            headers: {
                "Authorization": "Bearer " + token,
            },
    ...
    function showHandlingbills(){
      $("#handlingbills").html("");
        $.ajax({
            url: "https://localhost:5000/api/BillingAPI/handlingbills",
            type: "get",
            headers: {
                "Authorization": "Bearer " + token,
            },
    ...
    function showListOfBills(){
        ...
        $.ajax({
            url: "https://localhost:5000/api/BillingAPI/GetBillByDate",
            type: "post",
            headers: {
                "Authorization": "Bearer " + token,
            },
    ...
    $(document).on('click', '.viewprojectbills', function(){
        ...
        $.ajax({
            url: "https://localhost:5000/api/BillingAPI/projectbill/" + id,
            type: "get",
            headers: {
                "Authorization": "Bearer " + token,
            },
